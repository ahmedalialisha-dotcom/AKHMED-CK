...
type Props = { player: string; selectedTeam: string; onCareer: () => void; onScreen: (screen: NavigateScreen) => void; onPlayer: (name: string) => void; onTeam: (team: string) => void };
const players = [
...
export default function CareerScreen({ player, selectedTeam, onCareer, onScreen, onPlayer, onTeam }: Props) {
  return (
