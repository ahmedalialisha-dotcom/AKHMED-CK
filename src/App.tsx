...
export default function App() {
  ...
  if (screen === 'openWorld') {
    ...
    return <OpenWorldMode coins={coins} ownedItems={ownedItems} equippedItems={equippedItems} hairStyle={hairStyle} onHair={setHairStyle} onEquip={equip} onEat={eat} onOpenShop={() => { setShopReturn('openWorld'); setScreen('shop'); }} onExit={() => setScreen('menu')} />;
  }
