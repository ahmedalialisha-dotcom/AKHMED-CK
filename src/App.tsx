...
export default function App() {
  ...
  return <MainMenu screen={menuScreen} player={player} selectedTeam={selectedTeam} userEmail={user?.email} onStart={(mode) => { setTournament(mode); setScreen('match'); }} onTournament={(name) => { setTournament(name); setScreen('tournament'); }} onScreen={setScreen} onPlayer={setPlayer} onTeam={setSelectedTeam} />;
}
