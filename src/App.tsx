...
export default function App() {
  const [screen, setScreen] = useState<'menu' | 'quick' | 'penaltySelect' | 'match' | 'penalty' | 'career' | 'careerPlay' | 'settings' | 'shop' | 'tournament' | 'auth' | 'profile'>('menu');
